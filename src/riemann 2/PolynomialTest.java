...
public class PolynomialTest {
        ...
        public static void main(String[] args) 
        {
                ...
                p.print(); //prints the polynomial to the console window
                ...
                Coef C = p.evaluate(3); //plugs in 3 and returns the answer as a Coef which we call C
                 ...
                 * Term T contains only a double, and no other variable.
                 */
                
                //This process could have been streamlined by calling multiple methods in one line:
                double Y = P.evaluate(3).getTerms()[0].getTermDouble(); //as P and p are the same Y and y will also be the same
