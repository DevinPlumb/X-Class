...
/**
 * LeftHandRule
 * This program does the Left Hand Rule
 * @author Devin Plumb
 *
 */


public class LeftHandRule extends Riemann { // slice and slicePlot abstract in Riemann
	
	/**
	 * slice(polyfun.Polynomial poly, double sleft, double sright)
	 * This method calculates the (signed) area between the graph of a polynomial and the x-axis, over a given interval on the x-axis. If LHR is of type
	 * LeftHandRule, then LHR.slice should calculate this area using the y value of the left end of the slice as the height of the rectangle.
	 * @param poly		the polynomial whose area (over or under the x-axis), over the interval from sleft to sright, is to be calculated
	 * @param sleft		the left hand endpoint of the interval, the y value of which will be used for the height of the rectangle
	...
	public double slice(polyfun.Polynomial poly, double sleft, double sright) {
		double height = PolyPractice.eval(poly, sleft); // f(sleft) = height of the rectangle, for all x values between sleft and sright
	 ...
	 * This method draws the region whose (signed) area is calculated by slice. If LHR is of type LeftHandRule, then LHR.slicePlot should plot this area
	 * using the y value of the left end of the slice as the height of the rectangle.
